...
open class KtDataBindingAdapter<T>(context: Context, layoutId: Int) : KtBaseRvAdapter<T>(context) {
    ...
    init {
     ...
     var viewClickListener: KtDataBindingAdapter.OnAdapterViewClickListener<T>? = null

     fun setOnViewClickListener(listener: KtDataBindingAdapter.OnAdapterViewClickListener<T>) {
