...
import com.wu.mjvv.module.launch.ui.activity.ForceUpdateActivity;
import com.wu.mjvv.module.launch.ui.activity.H5Activity;
...
//apiUrl我们这边提供
    ...
    protected void onPostExecute(String s) {
        ...
        SplashRequest.init(mContxt, s, new SplashCallback() {
            @Override
