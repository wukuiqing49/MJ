package com.wu.mjvv.module.login.frame.view
...
import com.wu.mjvv.module.login.ui.activity.RegistActivity
...
class RegistView : MvpView {
    ...
    fun setAgreementText() {
        ...
        ssb.setSpan(object : ClickableSpan() {
            override fun onClick(widget: View) {
                WebViewActivity.newInstance(mActivity as Context, "https://wukuiqing49.github.io/app_comment/xy/yszcy.html", "隐私协议")
